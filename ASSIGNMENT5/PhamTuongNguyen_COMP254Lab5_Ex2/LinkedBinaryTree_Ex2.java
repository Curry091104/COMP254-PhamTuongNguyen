package PhamTuongNguyen_COMP254Lab5_Ex2;
...
public class LinkedBinaryTree_Ex2<E> extends AbstractBinaryTree<E> {
  ...
  public LinkedBinaryTree_Ex2() { }      // constructs an empty binary tree
   ...
   */
  public void attach(Position<E> p, LinkedBinaryTree_Ex2<E> t1,
                    LinkedBinaryTree_Ex2<E> t2) throws IllegalArgumentException {
    Node<E> node = validate(p);
  ...
  public static void main(String[] args)
  {
    ...
    LinkedBinaryTree_Ex2 lbt = new LinkedBinaryTree_Ex2();
  ...
  // Assignment question:
  public static <E> int heightAndElement(Position<E> p) {
    Node<E> node = (Node<E>) p;
    int height = 0;
    if (node == null) {
        return -1;
    } else {
        int leftHeight = heightAndElement(node.getLeft());
        int rightHeight = heightAndElement(node.getRight());
