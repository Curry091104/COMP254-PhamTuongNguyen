...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  // add maxLoadFactor parameter to constructor: Assignment 6
  public AbstractHashMap(int cap, int p, float maxLoadFactor) {
  ...
  public V put(K key, V value) {
    ...
    if (n > capacity / 2 * maxLoadFactor)              // keep load factor <= 0.5
