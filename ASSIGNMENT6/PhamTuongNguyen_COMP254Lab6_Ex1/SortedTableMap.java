...
public class SortedTableMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  public boolean containKey(K key)
  {
    ...
    int j = findIndex(key);
    if (j == size() || compare(key, table.get(j)) != 0) return false;
    return true;
  }
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Does the map contain key 5? " + map.containKey(5));
    System.out.println("Does the map contain key 6? " + map.containKey(6));
  }
}
